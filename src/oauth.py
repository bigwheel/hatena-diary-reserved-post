...
class OAuthClient():
    ...
    def prepare_request(self, url, token="", secret="", additional_params=None,
        ...
        message = "&".join(["GET" if method == urlfetch.GET else "PUT",
    ...
    def get_user_info(self, auth_token, auth_verifier=""):
        ...
        auth_secret = memcache.get(self._get_memcache_auth_key(auth_token)) #@UndefinedVariable
    ...
    def _get_auth_token(self, additional_params=None):
        ...
        memcache.set(self._get_memcache_auth_key(auth_token), auth_secret, #@UndefinedVariable
                                 time=20 * 60)
